...
|---|---|---|---|
| Event type | Logs | Logs / Metrics | **Logs** = log documents (all 134 services). **Metrics** = metrics documents (42 services with Elastic AWS metrics support). |
...
- **samples/metrics/** — one JSON metrics document per metrics-supported service (42 services)
