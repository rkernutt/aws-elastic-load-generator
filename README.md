...
1. **Select services** — toggle individual services, entire groups, or all 144 at once
2. **Choose mode** — **Logs** generates log documents for all 144 services; **Metrics** generates metrics documents for the 139 metrics-supported services; **Traces** generates APM trace documents for 20 services
...
|---|---|---|---|
| Event type | Logs | Logs / Metrics / Traces | **Logs** — all 144 services. **Metrics** — 139 metrics-supported services. **Traces** — 20 trace-supported services. |
...
- **samples/logs/** — 144 JSON log documents, one per service
