...
export const PIPELINE_REGISTRY = [
...

  {
    ...
    group: "analytics",
    description: "Parse Lake Formation permission event JSON",
  ...
  },
  {
    ...
    group: "analytics",
    description: "Parse QuickSight dashboard usage JSON",
  ...
  },
  {
    ...
    group: "analytics",
    description: "Parse DataBrew job execution JSON",
  ...
  },
  {
    ...
    dataset: "aws.appflow",
    group: "analytics",
    description: "Parse AppFlow connector run JSON",
  ...
  },
  {
    ...
    group: "analytics",
    description: "Parse OpenSearch Service operation JSON",
  ...
  },
  {
    ...
    group: "ml",
    description: "Parse Rekognition image/video analysis JSON",
  ...
  },
  {
    ...
    group: "ml",
    description: "Parse Textract document analysis JSON",
  ...
  },
  {
    ...
    group: "ml",
    description: "Parse Comprehend NLP analysis JSON",
  ...
  },
  {
    ...
    group: "ml",
    description: "Parse Comprehend Medical clinical NLP JSON",
  ...
  },
  {
    ...
    group: "ml",
    description: "Parse Translate language translation JSON",
  ...
  },
  {
    ...
    group: "ml",
    description: "Parse Transcribe speech-to-text job JSON",
  ...
  },
  {
    ...
    dataset: "aws.polly",
    group: "ml",
    description: "Parse Polly text-to-speech synthesis JSON",
  ...
  },
  {
    ...
    group: "ml",
    description: "Parse Forecast time-series prediction JSON",
  ...
  },
  {
    ...
    group: "ml",
    description: "Parse Personalize recommendation engine JSON",
  ...
  },
  {
    ...
    dataset: "aws.lex",
    group: "ml",
    description: "Parse Lex chatbot intent & session JSON",
    processors: json("lex"),
  },
  {
    ...
    group: "ml",
    description: "Parse Lookout for Metrics anomaly detector JSON",
...

  {
    ...
    group: "serverless",
    description: "Parse Step Functions execution event JSON",
  ...
  },
  {
    ...
    group: "serverless",
    description: "Parse App Runner container log JSON",
  ...
  },
  {
    ...
    dataset: "aws.appsync",
    group: "serverless",
    description: "Parse AppSync GraphQL request log JSON",
...

  {
    ...
    group: "compute",
    description: "Parse EC2 instance log JSON from message field",
    processors: json("ec2"),
  },

  {
    ...
    dataset: "aws.eks",
    group: "compute",
    description: "Parse EKS Kubernetes pod/node log JSON",
    processors: json("eks"),
  },
  {
    ...
    dataset: "aws.ecr",
    group: "compute",
    description: "Parse ECR image scan and push log JSON",
    processors: json("ecr"),
  },
  {
    ...
    dataset: "aws.batch",
    group: "compute",
    description: "Parse Batch job execution log JSON",
  ...
  },
  {
    ...
    group: "compute",
    description: "Parse Elastic Beanstalk deployment log JSON",
  ...
  },
  {
    ...
    group: "compute",
    description: "Parse Auto Scaling scale-in/out event JSON",
  ...
  },
  {
    ...
    group: "compute",
    description: "Parse Image Builder AMI pipeline log JSON",
...

  {
    ...
    group: "databases",
    description: "Parse ElastiCache Redis command log JSON",
  ...
  },
  {
    ...
    dataset: "aws.aurora",
    group: "databases",
    description: "Parse Aurora cluster event log JSON",
  ...
  },
  {
    ...
    dataset: "aws.docdb",
    group: "databases",
    description: "Parse DocumentDB MongoDB-compat query log JSON",
  ...
  },
  {
    ...
    dataset: "aws.neptune",
    group: "databases",
    description: "Parse Neptune graph DB query log JSON",
  ...
  },
  {
    ...
    group: "databases",
    description: "Parse Timestream write/query log JSON",
  ...
  },
  {
    ...
    dataset: "aws.qldb",
    group: "databases",
    description: "Parse QLDB ledger transaction log JSON",
  ...
  },
  {
    ...
    group: "databases",
    description: "Parse Keyspaces Cassandra-compat log JSON",
  ...
  },
  {
    ...
    group: "databases",
    description: "Parse MemoryDB durable Redis log JSON",
...

  {
    ...
    group: "storage",
    description: "Parse S3 Storage Lens analytics & metrics JSON",
  ...
  },
  {
    ...
    dataset: "aws.efs",
    group: "storage",
    description: "Parse EFS NFS throughput/I/O log JSON",
    processors: json("efs"),
  },
  {
    ...
    dataset: "aws.fsx",
    group: "storage",
    description: "Parse FSx file system ops log JSON",
    processors: json("fsx"),
  },
  {
  ...
  },
  {
    ...
    group: "storage",
    description: "Parse DataSync transfer task log JSON",
  ...
  },
  {
    ...
    group: "storage",
    description: "Parse Storage Gateway hybrid storage log JSON",
...

  {
    ...
    dataset: "aws.macie",
    group: "security",
    description: "Parse Macie S3 sensitive data finding JSON",
  ...
  },
  {
    ...
    group: "security",
    description: "Parse IAM Access Analyzer finding JSON",
  ...
  },
  {
    ...
    dataset: "aws.cognito",
    group: "security",
    description: "Parse Cognito user auth & sign-in event JSON",
  ...
  },
  {
    ...
    dataset: "aws.kms",
    group: "security",
    description: "Parse KMS key usage & rotation log JSON",
    processors: json("kms"),
  },
  {
    ...
    group: "security",
    description: "Parse Secrets Manager access & rotation log JSON",
  ...
  },
  {
    ...
    dataset: "aws.acm",
    group: "security",
    description: "Parse ACM certificate lifecycle log JSON",
    processors: json("acm"),
  },
  {
    ...
    group: "security",
    description: "Parse IAM Identity Center SSO auth log JSON",
  ...
  },
  {
    ...
    group: "security",
    description: "Parse Detective behavioural analysis finding JSON",
...

  {
    ...
    dataset: "aws.shield",
    group: "networking",
    description: "Parse Shield DDoS detection event JSON",
  ...
  },
  {
    ...
    group: "networking",
    description: "Parse Global Accelerator anycast routing log JSON",
  ...
  },
  {
    ...
    group: "networking",
    description: "Parse Direct Connect circuit log JSON",
  ...
  },
  {
    ...
    group: "networking",
    description: "Parse PrivateLink VPC endpoint log JSON",
...

  {
    ...
    group: "streaming",
    description: "Parse Firehose delivery stream log JSON",
  ...
  },
  {
    ...
    group: "streaming",
    description: "Parse Kinesis Analytics real-time app log JSON",
  ...
  },
  {
    ...
    group: "streaming",
    description: "Parse EventBridge event routing log JSON",
...

  {
    ...
    group: "iot",
    description: "Parse Greengrass edge component log JSON from message field",
...

  {
    ...
    group: "iot",
    description: "Parse IoT Analytics pipeline log JSON",
  ...
  },
  {
    ...
    group: "iot",
    description: "Parse IoT Defender audit finding JSON",
  ...
  },
  {
    ...
    group: "iot",
    description: "Parse IoT Events detector state machine JSON",
  ...
  },
  {
    ...
    group: "iot",
    description: "Parse IoT SiteWise industrial asset telemetry JSON",
...

  {
    ...
    group: "management",
    description: "Parse CloudWatch Alarms state change JSON",
  ...
  },
  {
    ...
    group: "management",
    description: "Parse Trusted Advisor check result JSON",
  ...
  },
  {
    ...
    group: "management",
    description: "Parse Control Tower guardrail/account event JSON",
  ...
  },
  {
    ...
    group: "management",
    description: "Parse Organizations account & policy event JSON",
  ...
  },
  {
    ...
    group: "management",
    description: "Parse Service Catalog provisioning event JSON",
  ...
  },
  {
    ...
    group: "management",
    description: "Parse Service Quotas utilisation alert JSON",
  ...
  },
  {
    ...
    group: "management",
    description: "Parse Compute Optimizer recommendation JSON",
  ...
  },
  {
    ...
    dataset: "aws.budgets",
    group: "management",
    description: "Parse Budgets cost threshold alert JSON",
  ...
  },
  {
    ...
    dataset: "aws.ram",
    group: "management",
    description: "Parse Resource Access Manager sharing event JSON",
    processors: json("ram"),
  },
  {
    ...
    group: "management",
    description: "Parse Resilience Hub RTO/RPO assessment JSON",
  ...
  },
  {
    ...
    group: "management",
    description: "Parse Migration Hub server migration status JSON",
  ...
  },
  {
    ...
    group: "management",
    description: "Parse Network Manager WAN topology log JSON",
  ...
  },
  {
    ...
    dataset: "aws.dms",
    group: "management",
    description: "Parse DMS database migration task log JSON",
    processors: json("dms"),
  },
...

  {
    ...
    group: "devtools",
    description: "Parse CodeDeploy deployment lifecycle JSON",
  ...
  },
  {
    ...
    group: "devtools",
    description: "Parse CodeCommit git push/PR event JSON",
  ...
  },
  {
    ...
    group: "devtools",
    description: "Parse CodeArtifact package publish/pull JSON",
  ...
  },
  {
    ...
    dataset: "aws.amplify",
    group: "devtools",
    description: "Parse Amplify build & deploy event JSON",
  ...
  },
  {
    ...
    dataset: "aws.xray",
    group: "devtools",
    description: "Parse X-Ray distributed trace segment JSON",
  ...
  },
  {
    ...
    group: "devtools",
    description: "Parse CodeGuru code quality finding JSON",
...

  {
    ...
    group: "enduser",
    description: "Parse WorkSpaces virtual desktop session JSON",
  ...
  },
  {
    ...
    group: "enduser",
    description: "Parse AppStream app streaming session JSON",
  ...
  },
  {
    ...
    group: "enduser",
    description: "Parse GameLift game server & matchmaking JSON",
  ...
  },
  {
    ...
    dataset: "aws.ses",
    group: "enduser",
    description: "Parse SES email send/bounce/complaint event JSON",
    processors: json("ses"),
  },
  {
    ...
    group: "enduser",
    description: "Parse Pinpoint campaign & journey delivery JSON",
  ...
  },
  {
    ...
    group: "enduser",
    description: "Parse Transfer Family SFTP/FTPS/AS2 transfer JSON",
  ...
  },
  {
    ...
    group: "enduser",
    description: "Parse Lightsail instance event JSON",
  ...
  },
  {
    ...
    group: "enduser",
    description: "Parse Fraud Detector ML risk decision JSON",
  ...
  },
  {
    ...
    group: "enduser",
    description: "Parse Location Service geofence & routing JSON",
  ...
  },
  {
    ...
    group: "enduser",
    description: "Parse Managed Blockchain transaction/network JSON",
  ...
  },
  {
    ...
    group: "enduser",
    description: "Parse DevOps Guru ML anomaly insight JSON",
  ...
  },
  {
    ...
    dataset: "aws.wafv2",
    group: "networking",
    description: "Parse WAF v2 web ACL allow/block event JSON",
  ...
  // Networking
  {
    ...
    group: "networking",
    description: "Parse VPC Lattice service network access log JSON",
  ...
  },
  {
    ...
    group: "security",
    description: "Parse CloudHSM HSM operation and key usage log JSON",
  ...
  // Streaming
  {
    ...
    group: "streaming",
    description: "Parse MSK Connect Kafka connector task log JSON",
  ...
  // Analytics
  {
    ...
    dataset: "aws.mwaa",
    group: "analytics",
    description: "Parse MWAA Airflow DAG and task execution log JSON",
  ...
  },
  {
    ...
    group: "analytics",
    description: "Parse Clean Rooms protected query log JSON",
  ...
  },
  {
    ...
    group: "analytics",
    description: "Parse DataZone data catalog and governance event JSON",
  ...
  },
  {
    ...
    group: "analytics",
    description: "Parse Entity Resolution matching workflow job log JSON",
  ...
  },
  {
    ...
    group: "analytics",
    description: "Parse Data Exchange subscription and job event JSON",
  ...
  // AI / ML
  {
    ...
    dataset: "aws.kendra",
    group: "aiml",
    description: "Parse Kendra enterprise search query and sync log JSON",
  ...
  },
  {
    ...
    group: "aiml",
    description: "Parse HealthLake FHIR data store operation log JSON",
  ...
  // IoT
  {
    ...
    group: "iot",
    description: "Parse IoT TwinMaker digital twin sync and query log JSON",
  ...
  },
  {
    ...
    group: "iot",
    description: "Parse IoT FleetWise vehicle signal campaign log JSON",
  ...
  // Developer Tools
  {
    ...
    group: "devtools",
    description: "Parse CodeCatalyst workflow run and dev environment log JSON",
  ...
  },
  {
    ...
    group: "devtools",
    description: "Parse Device Farm mobile test run log JSON",
  ...
  // Management
  {
    ...
    dataset: "aws.fis",
    group: "management",
    description: "Parse Fault Injection Service chaos experiment log JSON",
    processors: json("fis"),
  },
  {
    ...
    group: "management",
    description: "Parse Managed Grafana workspace and alert log JSON",
  ...
  },
  {
    ...
    group: "management",
    description: "Parse Supply Chain planning and integration event log JSON",
  ...
  },
  {
    ...
    dataset: "aws.arc",
    group: "management",
    description: "Parse App Recovery Controller zonal shift log JSON",
    processors: json("arc"),
  },
  ...
  // Media
  {
    ...
    group: "media",
    description: "Parse Deadline Cloud render farm job and task log JSON",
  ...
  // Networking
  {
    ...
    dataset: "aws.appmesh",
    group: "networking",
    description: "Parse App Mesh Envoy proxy access log JSON",
  ...
  },
  {
    ...
    group: "networking",
    description: "Parse Client VPN connection and auth log JSON",
  ...
  },
  {
    ...
    group: "networking",
    description: "Parse Cloud Map service discovery event JSON",
  ...
  // Compute
  {
    ...
    group: "compute",
    description: "Parse Outposts hybrid cloud capacity event JSON",
  ...
  // Security
  {
    ...
    group: "security",
    description: "Parse Audit Manager compliance assessment evidence JSON",
  ...
  },
  {
    ...
    group: "security",
    description: "Parse Verified Permissions Cedar authorization decision JSON",
  ...
  },
  {
    ...
    group: "security",
    description: "Parse Payment Cryptography key operation log JSON",
  ...
  },
  {
    ...
    group: "security",
    description: "Parse Artifact compliance report access log JSON",
  ...
  // Databases
  {
    ...
    dataset: "aws.dax",
    group: "databases",
    description: "Parse DynamoDB DAX cache hit/miss and operation log JSON",
    processors: json("dax"),
  },
  // Developer Tools
  {
    ...
    dataset: "aws.proton",
    group: "devtools",
    description: "Parse Proton environment and service deployment log JSON",
  ...
  // Analytics
  {
    ...
    group: "analytics",
    description: "Parse AppFabric SaaS audit log normalisation event JSON",
  ...
  },
  {
    ...
    dataset: "aws.b2bi",
    group: "analytics",
    description: "Parse B2B Data Interchange EDI transformation log JSON",
  ...
  // Management
  {
    ...
    group: "management",
    description: "Parse AppConfig configuration deployment event JSON",
  ...
  },
  {
    ...
    dataset: "aws.drs",
    group: "management",
    description: "Parse Elastic Disaster Recovery replication event JSON",
    processors: json("drs"),
  },
  {
    ...
    group: "management",
    description: "Parse License Manager grant and consumption event JSON",
  ...
  },
  {
    ...
    dataset: "aws.chatbot",
    group: "management",
    description: "Parse Chatbot notification delivery event JSON",
  ...
  // Media
  {
    ...
    group: "media",
    description: "Parse Chime SDK Voice call quality and SIP event JSON",
  ...
  // ── v11.1 NEW SERVICES ──────────────────────────────────────────────────────
  {
    ...
    group: "compute",
    description: "Parse Wavelength 5G edge compute and carrier gateway event JSON",
