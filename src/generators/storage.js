    ...
    aws: {
      ...
      s3: {
        ...
        metrics: {
          ...
          FirstByteLatency: {
            avg: parseFloat(randFloat(1, isErr ? 2000 : 100)),
            p99: parseFloat(randFloat(10, isErr ? 5000 : 500)),
          },
          TotalRequestLatency: {
            avg: parseFloat(randFloat(5, isErr ? 5000 : 500)),
            p99: parseFloat(randFloat(50, isErr ? 10000 : 2000)),
          },
        },
      },
      s3_request: {
    ...
    aws: {
      ...
      efs: {
        ...
        metrics: {
          ...
          PermittedThroughput: { avg: parseFloat(randFloat(1, 3000)) },
          MeteredIOBytes: { sum: randInt(1000, 1e9) },
          StorageBytes: { avg: randInt(1e6, 1e12) },
          PercentIOLimit: { avg: parseFloat(randFloat(1, isErr ? 95 : 40)) },
    ...
    aws: {
      ...
      fsx: {
        ...
        metrics: {
          ...
          CPUUtilization: { avg: parseFloat(randFloat(1, 80)) },
          NetworkThroughputUtilization: { avg: parseFloat(randFloat(1, 80)) },
        },
      },
    },
    event: {
    ...
    aws: {
      ...
      storagegateway: {
        ...
        metrics: {
          ...
          CloudDownloadLatency: { avg: parseFloat(randFloat(10, 5000)) },
          ...
          CachePercentDirty: { avg: parseFloat(randFloat(0, 20)) },
          CachePercentUsed: { avg: parseFloat(randFloat(10, 90)) },
        },
      },
    },
    event: {
