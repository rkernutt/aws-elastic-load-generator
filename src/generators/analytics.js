    ...
    "aws": {
      ...
      elasticmapreduce: {
        metrics: {
          ...
          MRTotalNodes: { avg: executorCount + 1 },
          MRActiveNodes: { avg: level === "error" ? 0 : executorCount },
          MRLostNodes: { avg: level === "error" ? randInt(1, executorCount) : 0 },
          ...
          MemoryAvailableMB: { avg: emrMetrics.yarn_memory_used_mb },
          MemoryReservedMB: { avg: randInt(512, 32768) },
          MemoryTotalMB: { avg: randInt(8192, 131072) },
