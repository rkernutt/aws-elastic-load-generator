...
function generateEmrLog(ts, er) {
  ...
  return {
    ...
    "aws": {
      ...
      elasticmapreduce: {
        metrics: {
          ...
          ContainerPendingRatio: { avg: level === "error" ? parseFloat(randFloat(0.5, 5.0)) : parseFloat(randFloat(0, 0.5)) },
    ...
    "process": { name: rand(["SparkSubmit","YARNAppMaster","HiveMetastore","PrestoCoordinator","FlinkTaskManager"]) },
    "log": { level },
