...
const RUNTIME_LANG = {
  "python3.11": "python", "python3.12": "python",
  "nodejs18.x": "nodejs", "nodejs20.x": "nodejs",
  "java21": "java",
};

const RUNTIME_VERSION = {
  "python3.11": "3.11.9", "python3.12": "3.12.3",
  "nodejs18.x": "18.20.4", "nodejs20.x": "20.15.1",
  "java21": "21.0.3",
};
 ...
 */
function txDoc({
  ts, traceId, txId, parentId,
  serviceName, environment, language, runtime, framework,
  txType, txName, durationUs,
  isErr, spanCount,
  cloud, faas, labels,
  distro = "elastic",
}) {
  const svcBlock        = serviceBlock(
    serviceName, environment, language,
    framework ?? null,
    runtime, RUNTIME_VERSION[runtime] ?? "1.0.0",
  );
...
function spanDoc({
  ts, traceId, txId, parentId,
  spanId,
  spanType, spanSubtype, spanName, spanAction,
  durationUs,
  isErr,
  db, destination, labels,
  serviceName, environment, language, runtime,
  distro = "elastic",
}) {
  const svcBlock        = serviceBlock(
    serviceName, environment, language,
  ...
  return {
    ...
    "span": {
      ...
      "action": spanAction,
      ...(db ? { "db": db } : {}),
      ...(destination ? { "destination": { "service": { "resource": destination, "type": spanType, "name": destination } } } : {}),
    },
    "service": svcBlock,
    "agent": agent,
    "telemetry": telemetry,
...
function workflowEcommerceOrder(ts, er) {
  ...
  docs.push(txDoc({
    ts: base.toISOString(),
    traceId, txId: apigwTxId,
    serviceName: "api-orders", environment: env,
    language: "nodejs", runtime: "nodejs20.x",
    framework: "AWS API Gateway",
    txType: "request", txName: "POST /orders",
  ...
  docs.push(spanDoc({
    ...
    traceId, txId: apigwTxId, parentId: apigwTxId,
    spanId: lambdaInvokeSpanId,
    spanType: "external", spanSubtype: "lambda",
  ...
  docs.push(txDoc({
    ...
    traceId, txId: orderProcessorTxId, parentId: lambdaInvokeSpanId,
    serviceName: "order-processor", environment: env,
    language: "python", runtime: "python3.12",
    framework: "AWS Lambda",
    txType: "lambda", txName: "order-processor",
  ...
  docs.push(spanDoc({
    ...
    traceId, txId: orderProcessorTxId, parentId: orderProcessorTxId,
    spanId: dynamoSpanId,
    spanType: "db", spanSubtype: "dynamodb",
  ...
  docs.push(spanDoc({
    ...
    traceId, txId: orderProcessorTxId, parentId: orderProcessorTxId,
    spanId: sqsSpanId,
    spanType: "messaging", spanSubtype: "sqs",
  ...
  docs.push(txDoc({
    ...
    traceId, txId: notifTxId, parentId: sqsSpanId,
    serviceName: "notification-sender", environment: env,
    language: "python", runtime: "python3.12",
    framework: "AWS Lambda",
    txType: "lambda", txName: "notification-sender",
    durationUs: notifTotalUs,
    isErr: false, spanCount: 1,
    cloud: cloudBlock(region, account, "lambda"),
    faas: notifFaas,
  }));
  ...
  docs.push(spanDoc({
    ...
    traceId, txId: notifTxId, parentId: notifTxId,
    spanId: sesSpanId,
    spanType: "messaging", spanSubtype: "ses",
...
function workflowMlInference(ts, er) {
  ...
  docs.push(txDoc({
    ts: base.toISOString(),
    traceId, txId: apigwTxId,
    serviceName: "api-ml", environment: env,
    language: "nodejs", runtime: "nodejs20.x",
    framework: "AWS API Gateway",
    txType: "request", txName: "POST /inference",
    durationUs: apigwTotalUs,
    isErr, spanCount: 1,
    cloud: cloudBlock(region, account, "apigateway"),
  }));
  ...
  docs.push(txDoc({
    ...
    traceId, txId: routerTxId, parentId: lambdaInvokeSpanId,
    serviceName: "inference-router", environment: env,
    language: "python", runtime: "python3.12",
    framework: "AWS Lambda",
    txType: "lambda", txName: "inference-router",
  ...
  docs.push(spanDoc({
    ...
    traceId, txId: routerTxId, parentId: routerTxId,
    spanId: s3SpanId,
    spanType: "storage", spanSubtype: "s3",
  ...
  docs.push(spanDoc({
    ...
    spanType: "gen_ai", spanSubtype: "bedrock",
...
function workflowDataIngestion(ts, er) {
  ...
  docs.push(txDoc({
    ts: base.toISOString(),
    traceId, txId: kinesisTxId,
    serviceName: "kinesis-stream", environment: env,
    language: "python", runtime: "python3.12",
    framework: null,
    txType: "messaging", txName: "clickstream process",
  ...
  docs.push(txDoc({
    ...
    traceId, txId: processorTxId, parentId: kinesisTxId,
    serviceName: "stream-processor", environment: env,
    language: "nodejs", runtime: "nodejs20.x",
    framework: "AWS Lambda",
    txType: "lambda", txName: "stream-processor",
  ...
  docs.push(spanDoc({
    ts: offsetTs(base, s3Offset),
    traceId, txId: processorTxId, parentId: processorTxId,
    spanId: s3SpanId,
    spanType: "storage", spanSubtype: "s3",
  ...
  docs.push(spanDoc({
    ...
    traceId, txId: processorTxId, parentId: processorTxId,
    spanId: glueSpanId,
    spanType: "external", spanSubtype: "glue",
  ...
  const emrSvcBlock = serviceBlock(
    "etl-job", env, "java",
    "Spark",
    "OpenJDK", "21.0.3",
  );
  ...
  const stages = [
    { id: stage0SpanId, offset: stage0Offset, us: stage0Us, name: "Stage 0: Read Kinesis Shard", type: "messaging", subtype: "kinesis", stageIdx: "0" },
    { id: stage1SpanId, offset: stage1Offset, us: stage1Us, name: "Stage 1: Parse & Validate Events", type: "compute", subtype: "spark", stageIdx: "1" },
    { id: stage2SpanId, offset: stage2Offset, us: stage2Us, name: "Stage 2: Write Enriched to S3", type: "storage", subtype: "s3", stageIdx: "2" },
  ];
  ...
  for (const [i, stage] of stages.entries()) {
    docs.push({
      ...
      "span": {
        ...
        "action": stage.type === "storage" ? "write" : stage.type === "messaging" ? "receive" : "execute",
      },
      "service": emrSvcBlock,
      "agent": emrAgent,
      "telemetry": emrTelemetry,
...
function workflowStepFunctions(ts, er) {
  ...
  docs.push(txDoc({
    ts: base.toISOString(),
    traceId, txId: ebTxId,
    serviceName: "eventbridge", environment: env,
    language: "nodejs", runtime: "nodejs20.x",
    framework: null,
    txType: "messaging", txName: "order.created process",
  ...
  docs.push({
    ...
    "service": serviceBlock("order-processing-workflow", env, "nodejs", null, "nodejs20.x", "20.15.1"),
  ...
  docs.push(spanDoc({
    ...
    traceId, txId: sfnTxId, parentId: sfnTxId,
    spanId: validateStateSpanId,
    spanType: "workflow", spanSubtype: "stepfunctions",
    spanName: "ValidateOrder",
    spanAction: "invoke",
    durationUs: validateStateUs,
    isErr: false,
    destination: "states",
    serviceName: "order-processing-workflow", environment: env,
    language: "nodejs", runtime: "nodejs20.x",
  }));
  ...
  docs.push(txDoc({
    ...
    traceId, txId: validatorTxId, parentId: validateStateSpanId,
    serviceName: "order-validator", environment: env,
    language: "python", runtime: "python3.11",
    framework: "AWS Lambda",
    txType: "lambda", txName: "order-validator",
  ...
  docs.push(spanDoc({
    ts: offsetTs(base, dynamoOffset),
    traceId, txId: validatorTxId, parentId: validatorTxId,
  ...
  docs.push(txDoc({
    ...
    traceId, txId: paymentTxId, parentId: paymentStateSpanId,
    serviceName: "payment-processor", environment: env,
    language: "java", runtime: "java21",
    framework: "AWS Lambda",
    txType: "lambda", txName: "payment-processor",
  ...
  docs.push(spanDoc({
    ...
    traceId, txId: paymentTxId, parentId: paymentTxId,
    spanId: rdsSpanId,
    spanType: "db", spanSubtype: "postgresql",
    ...
    db: {
      type: "sql",
      statement: "INSERT INTO payments (order_id, amount, status, created_at) VALUES ($1, $2, $3, NOW())",
    },
  ...
  docs.push(txDoc({
    ts: offsetTs(base, notifTxOffset),
    traceId, txId: notifTxId, parentId: confirmStateSpanId,
    serviceName: "notification-sender", environment: env,
    language: "python", runtime: "python3.12",
    framework: "AWS Lambda",
    txType: "lambda", txName: "notification-sender",
...
function workflowCascadingFailure(ts, _er) {
  ...
  const paymentHandlerUs = dynamoGetUs + dynamoPut1Us + dynamoPut2Us + sqsDlqUs + dlqProcessorUs + randInt(50, 150) * 1000;
  ...
  docs.push(txDoc({
    ts: base.toISOString(),
    traceId, txId: apigwTxId,
    serviceName: "api-payments", environment: env,
    language: "nodejs", runtime: "nodejs20.x",
    framework: "AWS API Gateway",
    txType: "request", txName: "POST /payments",
    durationUs: apigwTotalUs,
    isErr, spanCount: 1,
    cloud: cloudBlock(region, account, "apigateway"),
  }));
  ...
  docs.push(txDoc({
    ts: offsetTs(base, paymentTxOffset),
    traceId, txId: paymentHandlerTxId, parentId: lambdaInvokeSpanId,
    serviceName: "payment-handler", environment: env,
    language: "python", runtime: "python3.12",
    framework: "AWS Lambda",
    txType: "lambda", txName: "payment-handler",
    durationUs: paymentHandlerUs,
    isErr: true, spanCount: 4,
    cloud: cloudBlock(region, account, "lambda"),
    faas: paymentFaas,
  }));
  ...
  docs.push(spanDoc({
    ...
    traceId, txId: paymentHandlerTxId, parentId: paymentHandlerTxId,
    spanId: dynamoGetSpanId,
    spanType: "db", spanSubtype: "dynamodb",
    spanName: "DynamoDB.GetItem",
    spanAction: "GetItem",
  ...
  docs.push(txDoc({
    ...
    traceId, txId: dlqProcessorTxId, parentId: sqsDlqSpanId,
    serviceName: "dlq-processor", environment: env,
    language: "python", runtime: "python3.12",
    framework: "AWS Lambda",
    txType: "lambda", txName: "dlq-processor",
  ...
  docs.push(spanDoc({
    ...
    traceId, txId: dlqProcessorTxId, parentId: dlqProcessorTxId,
