  ...
  return {
    ...
    aws: {
      ...
      xray: {
        ...
        metrics: {
          ErrorRate: {
            avg: isClientErr ? parseFloat(randFloat(1, 20)) : parseFloat(randFloat(0, 1)),
          },
          FaultRate: { avg: isErr ? parseFloat(randFloat(1, 15)) : parseFloat(randFloat(0, 0.5)) },
          ThrottleRate: {
            avg: isThrottle ? parseFloat(randFloat(1, 10)) : parseFloat(randFloat(0, 0.5)),
          },
  ...
  return {
    ...
    aws: {
      codeguru: {
        ...
        frame_percent: product === "Profiler" ? parseFloat(randFloat(1, 50)) : null,
        error_code: isErr
