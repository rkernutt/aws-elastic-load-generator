...
import { generateAlbLog, generateNlbLog, generateCloudFrontLog, generateWafLog, generateRoute53Log, generateNetworkFirewallLog, generateShieldLog, generateVpcFlowLog } from "./networking.js";
import { generateGuardDutyLog, generateSecurityHubLog, generateMacieLog, generateInspectorLog, generateConfigLog, generateCognitoLog, generateKmsLog, generateCloudTrailLog } from "./security.js";
import { generateS3Log, generateEbsLog, generateEfsLog, generateFsxLog, generateDataSyncLog, generateBackupLog, generateStorageGatewayLog, generateS3StorageLensLog } from "./storage.js";
import { generateDynamoDbLog, generateElastiCacheLog, generateRedshiftLog, generateAuroraLog, generateRdsLog } from "./databases.js";
import { generateKinesisStreamsLog, generateFirehoseLog, generateSqsLog, generateSnsLog, generateEventBridgeLog, generateStepFunctionsLog } from "./streaming.js";
import { generateCodeBuildLog, generateCodePipelineLog, generateCodeDeployLog, generateXRayLog } from "./devtools.js";
...
import { generateIotCoreLog, generateIotGreengrassLog, generateIotAnalyticsLog, generateIotEventsLog, generateIotSiteWiseLog } from "./iot.js";
import { generateCloudFormationLog, generateSsmLog, generateCloudWatchAlarmsLog, generateHealthLog, generateBudgetsLog, generateDmsLog } from "./management.js";
import { generateWorkSpacesLog, generateConnectLog, generateSesLog, generateMediaConvertLog, generateMediaLiveLog, generateDevOpsGuruLog } from "./enduser.js";

const TS = new Date().toISOString();

/** Asserts ECS baseline fields present on every generator output. */
function assertBase(doc, ts) {
...
describe("Database generators", () => {
  ...
  it("RDS enhanced monitoring emits os_metrics", () => {
    ...
    for (let i = 0; i < 20; i++) {
      ...
      if (d.aws.rds.enhanced_monitoring) { emDoc = d; break; }
    }
    if (emDoc) {
