    ...
    "aws": {
      ...
      ec2: {
        ...
        metrics: {
          ...
          DiskReadBytes: { sum: randInt(0, 1e9), rate: parseFloat(randFloat(0, 1e6)) },
          DiskWriteBytes: { sum: randInt(0, 1e9), rate: parseFloat(randFloat(0, 1e6)) },
          DiskReadOps: { sum: randInt(0, 10000), rate: parseFloat(randFloat(0, 1000)) },
          DiskWriteOps: { sum: randInt(0, 10000), rate: parseFloat(randFloat(0, 1000)) },
          NetworkIn: { sum: randInt(1000, 1e9), rate: parseFloat(randFloat(0, 1e6)) },
          NetworkOut: { sum: randInt(1000, 1e9), rate: parseFloat(randFloat(0, 1e6)) },
          NetworkPacketsIn: { sum: randInt(100, 1e6), rate: parseFloat(randFloat(0, 10000)) },
          NetworkPacketsOut: { sum: randInt(100, 1e6), rate: parseFloat(randFloat(0, 10000)) },
