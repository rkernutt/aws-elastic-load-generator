    ...
    aws: {
      ...
      ec2: {
        ...
        cpu: {
          ...
          credit_usage: parseFloat(randFloat(0, 5)),
          credit_balance: parseFloat(randFloat(10, 500)),
        ...
        network: {
          in: {
            ...
            bytes_per_sec: parseFloat(randFloat(0, 1e6)),
            packets: randInt(100, 1e6),
            packets_per_sec: parseFloat(randFloat(0, 10000)),
          },
          out: {
            bytes: randInt(1000, 1e9),
            bytes_per_sec: parseFloat(randFloat(0, 1e6)),
        ...
        diskio: {
          read: {
            ...
            count_per_sec: parseFloat(randFloat(0, 1000)),
          },
          write: {
            bytes: randInt(0, 1e9),
            bytes_per_sec: parseFloat(randFloat(0, 1e6)),
