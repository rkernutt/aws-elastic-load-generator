      ...
      dynamodb: {
        ...
        metrics: {
          ...
          AccountProvisionedReadCapacityUtilization: {
            avg: parseFloat(randFloat(5, isErr ? 95 : 60)),
          },
          ...
          SuccessfulRequestLatency: {
            avg: parseFloat(randFloat(0.1, isErr ? 50 : 5)),
            max: parseFloat(randFloat(1, isErr ? 200 : 20)),
          },
...
function generateRedshiftLog(ts, er) {
  ...
  const dur = parseFloat(randFloat(0.1, isErr ? 300 : 60));
    ...
    aws: {
      ...
      redshift: {
        ...
        metrics: {
          ...
          WLMQueueWaitTime: {
            avg: isErr ? parseFloat(randFloat(5000, 60000)) : parseFloat(randFloat(0, 1000)),
          },
...
function generateOpenSearchLog(ts, er) {
  ...
  const dur = parseFloat(randFloat(1, isErr ? 30000 : 2000));
      ...
      neptune: {
        ...
        metrics: {
          ...
          GremlinRequestsPerSec: {
            avg: parseFloat(randFloat(0, queryLang === "Gremlin" ? 1000 : 0)),
          },
...
function generateRdsLog(ts, er) {
  ...
  const traceId = hasTrace ? randId(32) : null;
  const qt = parseFloat(randFloat(0.001, isErr ? 30 : 2));
  ...
  return {
    ...
    aws: {
      ...
      rds: {
        ...
        read_io: { ops_per_sec: parseFloat(randFloat(0, 3000)) },
        write_io: { ops_per_sec: parseFloat(randFloat(0, 3000)) },
        latency: {
          read: parseFloat(randFloat(0.001, isErr ? 0.5 : 0.02)),
          write: parseFloat(randFloat(0.001, isErr ? 0.5 : 0.01)),
        },
        throughput: {
        ...
        replica_lag: { sec: parseFloat(randFloat(0, isErr ? 10000 : 100)) },
