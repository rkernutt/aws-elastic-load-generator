    ...
    "aws": {
      ...
      dynamodb: {
        ...
        metrics: {
          ...
          AccountProvisionedReadCapacityUtilization: { avg: parseFloat(randFloat(5, isErr?95:60)) },
          ...
          SuccessfulRequestLatency: { avg: parseFloat(randFloat(0.1, isErr?50:5)), max: parseFloat(randFloat(1, isErr?200:20)) },
