...
const SERVICE_GROUPS: ServiceGroup[] = [
  ...
  },
  {
    ...
    services: [
      ...
      {
        id: "s3intelligenttier",
        label: "S3 Intelligent-Tiering",
        icon: "○",
        desc: "Tier transition & cost optimisation",
      },
      {
        id: "s3batchops",
        label: "S3 Batch Operations",
        icon: "≡",
        desc: "Bulk object transformation jobs",
      },
      ...
      { id: "rdsproxy", label: "RDS Proxy", icon: "⟳", desc: "Connection pooling & auth logs" },
      { id: "rdscustom", label: "RDS Custom", icon: "⊟", desc: "Custom engine patch & CEV logs" },
      { id: "dmsserverless", label: "DMS Serverless", icon: "⟺", desc: "Serverless migration task logs" },
      {
        id: "elasticacheglobal",
        label: "ElastiCache Global",
        icon: "⚡",
        desc: "Cross-region replication events",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    services: [
      ...
      {
        id: "sagemakerfeaturestore",
        label: "SageMaker Feature Store",
        icon: "⊞",
        desc: "Feature registry & retrieval logs",
      },
      {
        id: "sagemakerpipelines",
        label: "SageMaker Pipelines",
        icon: "⟿",
        desc: "ML workflow step execution logs",
      },
      {
        id: "sagemakermodelmonitor",
        label: "SageMaker Model Monitor",
        icon: "◎",
        desc: "Model drift & prediction quality",
      },
      {
        id: "lookoutequipment",
