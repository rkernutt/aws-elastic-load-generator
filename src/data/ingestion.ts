...
const SERVICE_INGESTION_DEFAULTS = {
  ...
  // v11.5 new services
  rdsproxy: "cloudwatch",
  rdscustom: "cloudwatch",
  dmsserverless: "cloudwatch",
  elasticacheglobal: "cloudwatch",
  ...
  sagemakerfeaturestore: "cloudwatch",
  sagemakerpipelines: "cloudwatch",
  sagemakermodelmonitor: "cloudwatch",
