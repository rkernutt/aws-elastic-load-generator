...
const ELASTIC_DATASET_MAP = {
  ...
  // v11.5 new services
  rdsproxy: "aws.rdsproxy",
  rdscustom: "aws.rdscustom",
  dmsserverless: "aws.dmsserverless",
  elasticacheglobal: "aws.elasticacheglobal",
  s3intelligenttier: "aws.s3_intelligent_tiering",
  s3batchops: "aws.s3_batch_operations",
  networkaccessanalyzer: "aws.networkaccessanalyzer",
  incidentmanager: "aws.incidentmanager",
  cloudshell: "aws.cloudshell",
  cloud9: "aws.cloud9",
  robomaker: "aws.robomaker",
  sagemakerfeaturestore: "aws.sagemaker_featurestore",
  sagemakerpipelines: "aws.sagemaker_pipelines",
  sagemakermodelmonitor: "aws.sagemaker_modelmonitor",
